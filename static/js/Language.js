var defaultEncoding=2;var translateDelay=0;var cookieDomain="http://youbbs.git.yangzhennan.com/";var msgToTraditionalChinese="<i class=\"fa fa-globe\"></i>繁體中文";var msgToSimplifiedChinese="<i class=\"fa fa-globe\"></i>简体中文";var translateButtonId="translateLink";var currentEncoding=defaultEncoding;var targetEncodingCookie="targetEncoding"+ cookieDomain.replace(/\./g,"");var targetEncoding=(getCookie(targetEncodingCookie)==null?defaultEncoding:getCookie(targetEncodingCookie));var translateButtonObject;function translateText(txt)
{if(txt==""||txt==null)
