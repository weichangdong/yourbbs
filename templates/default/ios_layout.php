...
<div class="footer-wrap">
    ...
    <div style="float: right;margin-top: -6px;font-size: 12px;"><i class="fa fa-heart"></i> Lovingly made by <a href="http://youbbs.git.yangzhennan.com/" target="_blank">EOEN</a></div>
